...
![](https://raw.githubusercontent.com/Duxah/FreePCB/master/pictures/По%20рукам.png) If you like version 2-030, place a `freepcb.dev` [logo](pictures/logo.png) with link on your site. Have fun using FreePcb-2
