...
FreeasyCapture распространяется под лицензией DonationWare и находится в открытом доступе. DonationWare не является частично-бесплатным ПО и не имеет ограничений функционала. Прежде чем вносить пожертвования вы можете скачать и попробовать данное ПО, чтобы удостовериться что оно вам подходит и что вы будете его использовать для разработок схем. Если вы планируете использовать FreeasyCapture для домашних разработок, то вы имеете право внести пожертвования. Если вы будете использовать это в коммерческих целях и получать прибыль то вы обязаны внести пожертвование хотя бы единожды. Сумма пожертвования должна быть не менее 5 долларов США. Ваши пожертвования идут чтобы покрыть расходы на разработку FreeasyCapture CDS и поддержку сайта freepcb.dev.
