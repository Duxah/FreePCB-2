...
***
_The latest version of FreePCB-2 with the option for export PCB to opencad (3d) is [here](https://github.com/niconson/Freepcb2-portable)_
...
In FreePcb, you can create a netlist manually by adding parts and then connecting their pins. But you can also import a netlist in the PADS-PCB popular format from FreePCB2 compatible Schematic Editor. See description on [this page](https://github.com/Duxah/FreePCB-2/blob/master/ECDS.md)
...
![](https://raw.githubusercontent.com/Duxah/FreePCB/master/pictures/По%20рукам.png) If you like, post [this]( https://github.com/Duxah/FreePCB-2/blob/master/README.md ) link on your website. Have fun using FreePcb-2.
...
1. [License](LICENSE)
2. [FreePcb user guide 1-359](https://github.com/Duxah/FreePcb-2/bin/doc/freepcb_user_guide.pdf)
